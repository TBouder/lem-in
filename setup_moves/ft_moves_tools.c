...
{
	if (color && room % 8 == 0)
		ft_printf("L%d-{0}%s{0} ", ant_id, room_name);
	else if (color && room % 6 == 0)
		ft_printf("L%d-{w}%s{0} ", ant_id, room_name);
	else if (color && room % 5 == 0)
		ft_printf("L%d-{y}%s{0} ", ant_id, room_name);
	else if (color && room % 4 == 0)
		ft_printf("L%d-{g}%s{0} ", ant_id, room_name);
	else if (color && room % 3 == 0)
		ft_printf("L%d-{c}%s{0} ", ant_id, room_name);
	else if (color && room % 2 == 0)
		ft_printf("L%d-{b}%s{0} ", ant_id, room_name);
	else if (color && room % 1 == 0)
		ft_printf("L%d-{r}%s{0} ", ant_id, room_name);
	else if (color)
